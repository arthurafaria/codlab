...
export const strings = {
  pt: {
    ...
    importer: {
      ...
      a3: "A rodada de exemplo tem 30 unidades fictícias e 28 variáveis, já pela metade.",
      a3cta: "Abrir exemplo",
  ...
  en: {
    ...
    importer: {
      ...
      a3: "The example round has 30 fictional units and 28 variables, already half done.",
