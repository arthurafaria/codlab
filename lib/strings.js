...
export const strings = {
  pt: {
    ...
    guide: {
      ...
      map2:
        "Quando isso acontece, o CodLAB não adivinha. Ele mostra as colunas que ficaram sem seção de um lado, as seções que ficaram sem coluna do outro, e você liga as duas num menu. Depois de ligar, o critério aparece na ficha normalmente.",
      map3:
...
irrCAC::bp.coeff.raw(cbind(ana$Desinfo_Emocional,
    ...
    importer: {
      ...
      mapLead:
        "Estas colunas da planilha não têm seção com o mesmo nome no livro de códigos. Costuma ser renomeação: o livro diz Funcao_Panico e a planilha diz Efeito_Panico. Escolha a seção correspondente, ou deixe em branco.",
  ...
  en: {
    ...
    guide: {
      ...
      map2:
        "When that happens CodLAB does not guess. It shows the columns left without a section on one side, the sections left without a column on the other, and you connect them in a menu. Once connected, the criterion shows on the form as usual.",
      map3:
...
irrCAC::bp.coeff.raw(cbind(ana$Desinfo_Emocional,
    ...
    importer: {
      ...
      mapLead:
        "These spreadsheet columns have no section with the same name in the codebook. It is usually a rename: the codebook says Funcao_Panico and the spreadsheet says Efeito_Panico. Pick the matching section, or leave it blank.",
