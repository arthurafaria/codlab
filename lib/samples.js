...
// Exemplo pequeno de propósito: cabe numa demonstração e cada variável aqui
// tem seção correspondente no livro de códigos de exemplo. Um para um.
const BOOLEANAS = [
  "Conteudo_Eleitoral",
  "Desinfo_Emocional",
  "Desinfo_Urgencia",
...
export const CODEBOOK_VARIABLES = [
  ...
  [
    "Desinfo_Conspiracao",
    "Sugere plano oculto ou articulação secreta?",
    "Variável binária. Atribui o resultado narrado à ação secreta e coordenada de um grupo, sem evidência proporcional à alegação.",
    null,
  ],
  [
    "Efeito_Panico",
